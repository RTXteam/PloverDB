...
| `trapi_attribute_map`            | object | **Required**             | TODO <br/> **Example:** `{}`                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `convert_input_ids`              | boolean  | **Strongly Recommended** | Specifies whether Plover should convert node identifiers used in queries to the equivalent version of those identifiers used in the graph. The source Plover uses for such equivalence mappings is either the grah itself (it looks for `equivalent_ids`, `equivalent_curies`, or `equivalent_identifiers` properties on nodes) or, if such a property is not present on nodes, the SRI Node Normalizer (via batch querying at build time). Default is `false`.  <br/> **Example:** `true` |
...
| `zip`                            | object   | Optional             | Relevant only for TSV-formatted graphs. Provides a way to "zip" array columns to form nested attributes in TRAPI responses. TODO explain more <br/> **Example:** `{"supporting_studies": {"properties": ["nctid", "phase", "tested", "primary_purpose"], "leader": "nctid"}}`                                                                                                                                                                                                              |
...
| `sources_template`               | object   | Optional             | TODO <br/> **Example:** `{}`                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
TODO: explain how sources are constructed?
